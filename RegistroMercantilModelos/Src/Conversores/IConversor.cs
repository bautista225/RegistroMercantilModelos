...
namespace RegistroMercantilModelos.Conversores
{
    ...
    /// <summary>
    /// Interfaz para el formateo de valores según su tipo.
    /// </summary>
    interface IConversor : IEmpaquetable
    {
        ...
        object EstableceValor(object valor);

        /// <summary>
        /// Formatea un dato según el tipo que es.
        /// </summary>
        /// <returns> Dato formateado según su tipo.</returns>
